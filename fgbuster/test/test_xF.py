...
class TestXfCompSep(unittest.TestCase):
    ...
    def test_d0s0(self):
		...
		EXT_BETA = [ 1.54000015, -3.00000035, 19.99999402]
		...
		aac(EXT_BETA, res.x)
		aac(EXT_SIGMA_BETA, res.Sigma)
		aac(EXT_NOISE_POST_COMP_SEP, res.noise)
		aaae(EXT_BIAS_R, res.cosmo_parameters['r'])
		aaae(EXT_SIGMA_R, res.cosmo_parameters['sigma_r'])
